...
str(dat)
#> List of 7
#>  $ X         : num [1:500, 1:10] -1.134 -1.973 -0.461 -0.219 -0.25 ...
#>   ..- attr(*, "dimnames")=List of 2
#>   .. ..$ : NULL
#>   .. ..$ : chr [1:10] "X1" "X2" "X3" "X4" ...
#>  $ A         : int [1:500] 1 0 0 0 0 1 1 1 1 1 ...
#>  $ Y         : num [1:500] -4.181 -8.72 -6.27 -0.833 -3.603 ...
#>  $ propensity: num [1:500] 0.25 0.25 0.25 0.25 0.25 ...
#>  $ ate       : num 0
#>  $ n         : num 500
#>  $ p         : num 10
