...
Table: Solver comparison (no cross-fitting, B = 1,000).
...
competitive at $n = 10{,}000$ but does not scale to larger problems.  All
solvers produce similar ATE estimates.
